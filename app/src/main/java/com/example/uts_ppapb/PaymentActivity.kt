...
import com.example.uts_ppapb.databinding.ActivityPaymentBinding
...
class PaymentActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        with(binding){
            ...
            val timePickerDialog = TimePickerDialog(this@PaymentActivity, TimePickerDialog.OnTimeSetListener { _: TimePicker, hourOfDay: Int, minute: Int ->
            ...
            DatePicker.setOnClickListener{
                val datePickerDialog=DatePickerDialog(this@PaymentActivity,datePicker,myCalendar.get(Calendar.YEAR),myCalendar.get(Calendar.MONTH),myCalendar.get(Calendar.DAY_OF_MONTH))
...
//            spinner Adapter semua disini
            val BioskopList=ArrayAdapter(this@PaymentActivity, android.R.layout.simple_spinner_dropdown_item,BioskopLocation)
            BioskopList.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item)
            spinnerBioskop.adapter=BioskopList

            val BankList=ArrayAdapter(this@PaymentActivity,android.R.layout.simple_spinner_dropdown_item,BankList)
            BankList.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item)
            spinnerMethodDetail.adapter=BankList

            val SeatList=ArrayAdapter( this@PaymentActivity,android.R.layout.simple_spinner_dropdown_item,SeatList)
            SeatList.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item)
            spinnerSeat.adapter=SeatList

            val PaymentMethodList=ArrayAdapter(/* context = */ this@PaymentActivity,/* resource = */ android.R.layout.simple_spinner_dropdown_item,PaymentMethod)
